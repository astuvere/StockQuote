...
public class MainListActivity extends ListActivity {
	...
	private static ArrayList<WatchList> watchLists = new ArrayList<WatchList>();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// for (byte i = 1; i <= 3; i++) {
		// String listString = fs.getKeyValue("W" + String.valueOf(i));
		// if (!listString.equals("")) {
		// watchLists.add(gson.fromJson(listString, WatchList.class));
		// }
		// }
		// }
		...
		Runnable runnable = new Runnable() {
			...
			public void run() {
				...
				try {
					...
					// "{}&& {identifier:'ID', label:'As at 28-03-2013 5:04 PM',"
					// +
					...
					SGXStockResponse response = Util.gson.fromJson(responseString, SGXStockResponse.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.watch1:
			...
			try {
				...
				// store.setKeyValue("T1", datetime);
				//
				datetime = store.getKeyValue("W1");
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		//Toast.makeText(this, records.get(i).N, Toast.LENGTH_SHORT).show();
